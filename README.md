...
```bash
# Database
DATABASE_URL=postgresql://user:password@localhost:5432/daigrams_diagram-management
...
SERVICE_PORT=8080
SERVICE_NAME=diagram-management
```
...
```bash
# Build image
docker build -t daigrams-diagram-management .

# Run container
docker run -p 8080:8080 daigrams-diagram-management
```
